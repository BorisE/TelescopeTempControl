...
namespace TelescopeTempControl
{
    ...
    public static class ConfigManagement
    {
        ...
        public static string ProgDocumentsFolderName = "TelescopeTempControl"; //set this property to change 
        ...
        public static string CONFIG_FILENAME = "TelescopeTempControl.config";
        public static string CONFIG_PATH = Path.Combine(ProgDocumentsPath, "Config") + "\\";
        public static string DEFAULT_CONFIG_FILENAME = "TelescopeTempControl.defaultconfig.txt"; //Default config file
