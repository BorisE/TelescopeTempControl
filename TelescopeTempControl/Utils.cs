...
namespace TelescopeTempControl
{
    class AuxilaryProc
    {
        ...
        {
            Logging.AddLog("UpgradeSettings enter",LogLevel.Trace);
            //Import settings from previously compiled versions
            if (Properties.Settings.Default.UpgradeRequired)
            {
                Logging.AddLog("Settings were copied from previous compile",LogLevel.Activity);
                Properties.Settings.Default.Upgrade();
                Properties.Settings.Default.UpgradeRequired = false;
            }
            
            Logging.AddLog("UpgradeSettings exit", LogLevel.Trace);
        }
